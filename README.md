#### Dockerizing a React Redux TypeScript app
...
create a React Redux TypeScript container

```zsh
$ docker build -t {yourDockerUsername}/react-redux-ts-app:1.0.0 .
```

Test the React Redux TypeScript container by running it. It should be visible at localhost:8080

```zsh
$ docker run -p 8080:80 {yourDockerUsername}/react-redux-ts-app:1.0.0
```

Push the container to your Docker Hub account repository

```zsh
$ docker push {yourDockerUsername}/react-redux-ts-app:1.0.0
```
